class UsersController < ApplicationController
  before_action :set_user, except: %i[payment add_card]
  before_action :authenticate_user!, except: [:show]
  before_action :forbid_test_user, only: %i[update exit destroy]
  before_action :ensure_correct_user, only: %i[profile description photo_upload favorite_store update destroy]
